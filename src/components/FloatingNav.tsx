...
export function FloatingNav() {
  const socialLinks = [
    { icon: Github, href: 'https://github.com/ishwargupta2004', label: 'GitHub' },
    { icon: Linkedin, href: 'https://www.linkedin.com/in/ishwar-gupta-9983a5315/', label: 'LinkedIn' },
    { icon: Twitter, href: 'https://x.com/IshwarGupt60868', label: 'Twitter' },
    { icon: Instagram, href: 'https://www.instagram.com/ishwargupta2004/', label: 'Instagram' },
    { icon: MessageCircle, href: 'https://wa.me/917742213060', label: 'WhatsApp' },
    { 
      icon: () => (
      ...
      href: 'https://leetcode.com/u/frostok/', 
      label: 'LeetCode' 
    },
    { icon: Mail, href: 'mailto:eshugupta176@gmail.com', label: 'Email' },
  ];
